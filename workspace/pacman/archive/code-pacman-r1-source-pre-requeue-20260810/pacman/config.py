...
SCATTER_CHASE_SCHEDULE = (
    # (mode, duration_seconds) 序列：S, C, S, C, S, C, S, ∞CHASE
    (Mode.SCATTER, None),  # 由 scatter_duration_for_level 动态计算
)
# 实际交替：第 N 段由 mode_phase 索引，phase 0~6 交替 S/C，第 7 段固定 CHASE 不切换
